...
- **ファイルアップロード** — 画像、PDF、Excel などをチャットに直接送信すると、AI がネイティブに読み取り分析
...
ファイルをチャットにドラッグするだけで、AI がネイティブに読み取り分析します：
- 🖼️ 画像（jpg、png、gif、webp）
- 📄 PDF
- 📊 Excel / CSV などのデータファイル
- 📝 テキストファイル全般

ファイルはワークスペースの `uploads/` フォルダに保存され、10 分後に自動削除されます。
