...
if python3 -m pip install --user youtube-transcript-api openai-whisper 2>&1 || \
   python3 -m pip install --break-system-packages --user youtube-transcript-api openai-whisper 2>&1; then
